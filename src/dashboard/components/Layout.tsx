        ...
        <div className="container mx-auto px-4 py-3 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className="w-8 h-8 bg-blue-600 rounded-md flex items-center justify-center">
              ...
              >
                <path
                  d="M4 2h16a2 2 0 0 1 2 2v16a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2zm1 3v14h14V5H5zm4 2h2v10H9V7zm4 0h2v10h-2V7z"
                />
              </svg>
            </div>
          ...
          <div className="flex items-center gap-2">
            <button 
              className="inline-flex items-center justify-center rounded-full w-8 h-8 text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-800 focus:outline-none focus:ring-2 focus:ring-blue-500"
              aria-label="Settings"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
            ...
            <div className="relative">
              <button
                className="inline-flex items-center justify-center rounded-full w-8 h-8 bg-blue-100 text-blue-700 dark:bg-blue-900 dark:text-blue-200 focus:outline-none focus:ring-2 focus:ring-blue-500"
