...
var AuthService = /** @class */ (function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        if (error) {
                            return [2 /*return*/, { user: null, error: error.message }];
                        }
                        if (!data || !data.user) {
                            return [2 /*return*/, { user: null, error: 'No user data returned' }];
                        }
                        return [2 /*return*/, {
                                user: {
                                    id: data.user.id,
    ...
    AuthService.prototype.resetPassword = function (email) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, supabase_1.supabase.auth.resetPasswordForEmail(email, {
